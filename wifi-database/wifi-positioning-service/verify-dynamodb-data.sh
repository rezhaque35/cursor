...
get_item "00:11:22:33:44:01" | jq -r '.Item | {mac_address: .mac_address.S, ssid: .ssid.S, signal_strength_avg: .signal_strength_avg.N, best_method: .best_method.S}'

# Check High Density Test Case
echo -e "\n2. High Density AP Test Case:"
get_item "00:11:22:33:44:11" | jq -r '.Item | {mac_address: .mac_address.S, ssid: .ssid.S, signal_strength_avg: .signal_strength_avg.N, best_method: .best_method.S}'

# Check Weak Signal Test Case
echo -e "\n3. Weak Signal Test Case:"
get_item "00:11:22:33:44:05" | jq -r '.Item | {mac_address: .mac_address.S, ssid: .ssid.S, signal_strength_avg: .signal_strength_avg.N, best_method: .best_method.S}'

# Check Error Case
echo -e "\n4. Error Case:"
get_item "00:11:22:33:44:36" | jq -r '.Item | {mac_address: .mac_address.S, ssid: .ssid.S, status: .status.S, error_type: .error_type.S}'
